// src/services/ai/prompts.ts — 所有 AI Prompt 集中管理（§8.3，便于调优与版本管理）

export const PROMPTS = {
  /** 从简历文本提取候选人结构化信息 */
  RESUME_EXTRACTION: `你是一位资深的猎头顾问助手。请从以下简历内容中提取候选人的结构化信息。
...
{{resumeText}}`,
  ...
  /** 从 JD 文本提取结构化搜索条件 */
  JD_PARSING: `你是一位资深的猎头顾问。请分析以下岗位 JD，提取关键信息。
...
{{jdText}}`,
  ...
  /** 技能可迁移性分析 */
  SKILL_TRANSFER: `你是技术领域的专家。请分析以下技能之间的关联性和可迁移性。
...
{{voiceText}}`,
  ...
  /** 图片/名片信息提取 */
  IMAGE_EXTRACTION: `请从这张图片中提取所有可见的文字信息，并识别：
